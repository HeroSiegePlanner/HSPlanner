## Fixes
- Fix `Tire Fire` tags
- Skull Axe relic gains its missing Demon Form proc (20% when Attacking, Level 1-10) - togglable under Config, scaling 24%+6%/lvl attack damage and 8%+2%/lvl attack speed
