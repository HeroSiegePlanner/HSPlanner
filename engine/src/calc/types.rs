...
pub struct ItemBase {
    ...
    #[serde(default)]
    pub rainbow_sockets: Option<Vec<u32>>,
    #[serde(default)]
...
pub struct PassiveConvert {
    ...
    #[serde(default)]
    pub pct: f64,
    // total pct = base_pct + pct * rank; tooltips quote the rank-1 value,
...
pub struct GameConfig {
    ...
    #[serde(default)]
    pub ailment_base_fraction: Option<StatMap>,
    #[serde(default)]
