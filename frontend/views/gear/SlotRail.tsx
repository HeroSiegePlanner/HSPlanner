...
export function GearPanel({
  ...
  return (
    ...
    >
      ...
      {/* w-0 min-w-full: header renders full-width but never widens the panel */}
      <div className="mb-3 flex w-0 min-w-full items-center justify-between gap-3 border-b border-accent-deep/20 pb-2">
