...
import { percentDelta, rangedBounds, type BuildPerformance, type BuildPerformanceDeps } from '../../../utils/build/buildPerformance'
...
export function hitDpsDiff(before: BuildSummary, after: BuildSummary): StatDiff | null {
  ...
  return {
    ...
    delta: afterAvg - beforeAvg,
    kind,
    deltaPct: percentDelta(beforeMin, beforeMax, afterAvg - beforeAvg),
  }
}
